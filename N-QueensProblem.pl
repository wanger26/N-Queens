...
%Using numlist(low, High, List) method to create a list from 1 to N to use to find a solution
eightQueens(Board, N) :- numlist(1, N, List), permutation(List,Board) , checkDiagonals(Board).
